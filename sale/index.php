...
<html lang="en">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">OWEN Company</a>
...
$saleSTMT = $dbh->prepare('select
  ...
  sale.unit_price as unit_price, sale.date as date from sale
join product on sale.product_id = product_id
');
$saleSTMT ->execute();
